...
class GameFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.submitAnswerButton.setOnClickListener {
            when(binding.radioGroupAnswers.checkedRadioButtonId){
                0 -> viewModel.validateAnswer(binding.radioButtonAnswer1.text.toString())
                1 -> viewModel.validateAnswer(binding.radioButtonAnswer2.text.toString())
                2 -> viewModel.validateAnswer(binding.radioButtonAnswer3.text.toString())
